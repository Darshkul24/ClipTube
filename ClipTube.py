...
class ClipTubeApp:
    ...
    def show_history(self):
        ...
        tree = Treeview(history_window, columns=("Title", "Author", "Date", "Size", "Time Taken"), show="headings")
        ...
        for record in self.history:
            tree.insert("", tk.END, values=(record["title"], record["author"], record["date"], record["size"], record["time_taken"]))

        tree.bind("<Double-1>", self.open_history_record)
